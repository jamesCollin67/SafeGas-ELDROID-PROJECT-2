...
class LeakHistoryAdapter(private var list: List<LeakHistoryRecord>) :
    RecyclerView.Adapter<LeakHistoryAdapter.ViewHolder>() {
    ...
    fun updateData(newList: List<LeakHistoryRecord>) {
        list = newList
